...
既然递和归都是存在的, **那么自顶向下也可以借鉴自底向上的整体思维, 即带上返回值**, 让当前问题(父节点)依赖于子问题的结果进行计算/汇总
```java
...
```
这类题目见LC100. 相同的树; 101. 对称二叉树; LCR 145. 判断对称二叉树; LC129. 求根节点到叶节点数字之和; 226. 翻转二叉树解法二; 1448. 统计二叉树中好节点的数目解法二; 1022. 从根到叶的二进制数之和解法二
LC965. 单值二叉树; 951. 翻转等价二叉树; 1379. 找出克隆二叉树中的相同节点; 617. 合并二叉树
