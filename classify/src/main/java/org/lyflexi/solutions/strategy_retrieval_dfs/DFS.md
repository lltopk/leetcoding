...
```
这类题目见LC100. 相同的树; 101. 对称二叉树; LCR 145. 判断对称二叉树; LC129. 求根节点到叶节点数字之和; 226. 翻转二叉树解法二; 1448. 统计二叉树中好节点的数目解法二

---

注：上述数学归纳模板均不考虑回溯, 回溯见后面章节# 通用回溯类问题
