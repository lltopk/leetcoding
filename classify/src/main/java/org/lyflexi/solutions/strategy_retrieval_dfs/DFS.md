...
**这类题目的特征是既有自顶向下的`state/layers`向下传递计算, 又有当前问题(父节点)依赖于子问题的结果进行计算/汇总**, 我把这类题叫做: 自顶向下有递也有归
```java
...
```
见LC129. 求根节点到叶节点数字之和; 112. 路径总和解法二; 226. 翻转二叉树解法二; 1448. 统计二叉树中好节点的数目解法二; 1022. 从根到叶的二进制数之和解法二
