 ...
 */
public class LC865_subtreeWithAllDeepest2 {
    ...
    private int dfs(TreeNode node, int depth) {
        ...
        maxDepth = Math.max(maxDepth, depth + 1); // 维护全局最大深度
        ...
        if (leftMaxDepth == rightMaxDepth && leftMaxDepth == maxDepth) {
            ...
            // 由于该递归函数是求当前子树最深叶节点的深度, 因此父节点和叶子节点都满足该条件: if (leftMaxDepth == rightMaxDepth && leftMaxDepth == maxDepth), 因此最终父节点一定会覆盖叶子节点
            ans = node;
        }
