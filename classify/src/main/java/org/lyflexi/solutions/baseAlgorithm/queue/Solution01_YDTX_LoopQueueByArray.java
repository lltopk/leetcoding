package org.lyflexi.solutions.baseAlgorithm.queue;
...
public class Solution01_YDTX_LoopQueueByArray {
        private int front;
        ...
        public Solution01_YDTX_LoopQueueByArray(int k) {
            //队列判空的条件是front==rear
    ...
    public static void main(String[] args) {
        ...
        Solution01_YDTX_LoopQueueByArray ques03LoopQueue = new Solution01_YDTX_LoopQueueByArray(k);
