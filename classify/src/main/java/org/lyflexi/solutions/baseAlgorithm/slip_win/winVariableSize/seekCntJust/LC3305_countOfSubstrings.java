package org.lyflexi.solutions.baseAlgorithm.slip_win.winVariableSize.seekCntJust;
 ...
 */
public class LC3305_countOfSubstrings {
    public int countOfSubstrings(String word, int k) {
        char[] wordArray = word.toCharArray();
        int geCnt0 = longerLegal(wordArray, k);
        int geCnt1 = longerLegal(wordArray, k+1);
        return geCnt0 - geCnt1;
    }

    private int longerLegal(char[] wordArray, int target){
